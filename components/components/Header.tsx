...
const Header: React.FC<HeaderProps> = ({ siteTitle, subTitle, showLlmLogPanel, onToggleLlmLogPanel, onToggleHowToUse, darkMode = false, onToggleDarkMode, theme = 'default', onThemeChange }) => {
    ...
    <>
            ...
            {onToggleDarkMode && onThemeChange && (
              <div className="mobile-theme-controls">
                ...
                <li>
                  <select
                    value={theme}
                    onChange={(e) => { onThemeChange(e.target.value); setIsMobileMenuOpen(false); }}
      ...
      <style>{`
        ...
        .headline.header-headline {
          font-size: 2.5rem; /* Bigger and more prominent */
          color: var(--color-headline);
          font-family: var(--font-display);
          text-transform: none; /* Remove uppercase for more friendly look */
          margin: 0;
          line-height: 1.1;
          ...
          animation: bubbleGradient 3s ease-in-out infinite;
        ...
        .theme-toggle {
          ...
          padding: 0.3rem;
          background: none;
          border: 1px solid var(--color-border, light-dark(#e0e0e0, #3a3a3f));
          border-radius: 4px;
